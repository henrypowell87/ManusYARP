...
/*
  ...
  * Author:Jonas Gonzalez & Henry Powell
...
#ifndef MANUSYARP_MANUSYARPMODULE_H
#define MANUSYARP_MANUSYARPMODULE_H
...
#include "manusYarpRateThread.h"

class manusYarpModule:public yarp::os::RFModule {
    ...
    /*  */
    manusYarpRatethread *rThread;             // pointer to a new thread to be created and started in configure() and stopped in close()
...
#endif //MANUSYARP_MANUSYARPMODULE_H
