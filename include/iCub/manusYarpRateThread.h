...
/*
  ...
  * Author:Author:Jonas Gonzalez & Henry Powell
...
#ifndef _MANUSYARP_RATETHREAD_H_
#define _MANUSYARP_RATETHREAD_H_
...
class manusYarpRatethread : public yarp::os::RateThread {
private:
    ...
    std::string fileName;           // file name of outputted .csv file
...
public:
    ...
    * constructor default
    */
//    manusYarpRatethread(const std::string t_recordHandType);
//
//    //manusYarpRatethread(const int _sampleRate);
//
//    manusYarpRatethread(const std::string _fileName);
    /**
    * constructor
    * @param robotname name of the robot
    */
    manusYarpRatethread(std::string robotname,std::string configFile);
    ...
    */
    ...
    void setRecordHandType(std::string t_recordHandType);
...
//    std::string getRecordHandType(const char* _hand);
//
//    std::string getfileName(const char* _fileName);
...
#endif  //_MANUSYARP_RATETHREAD_H_
